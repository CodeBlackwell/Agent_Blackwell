...
Chronological Integrity – Entries must be appended in ascending chronological order. Existing text may never be modified or deleted—only *Prepended* (Insert at the beginning).
