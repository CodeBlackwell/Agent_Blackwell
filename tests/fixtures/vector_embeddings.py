...
def generate_similar_embedding(
    base_embedding: List[float], similarity: float = 0.8
) -> List[float]:
...
def create_embedding_clusters(
    num_clusters: int = 3, items_per_cluster: int = 5
) -> Dict[str, Any]:
    ...
    for cluster_id in range(num_clusters):
        ...
        clusters[cluster_name] = {"center": center_embedding, "items": []}
...
def generate_search_test_data() -> Dict[str, Any]:
    ...
    search_data = {"documents": [], "queries": [], "expected_matches": {}}
    ...
    search_data["queries"] = [
        {
            ...
            "embedding": generate_similar_embedding(
                search_data["documents"][0]["embedding"], 0.85
            ),
        ...
        },
        {
            ...
            "embedding": generate_similar_embedding(
                search_data["documents"][1]["embedding"], 0.85
            ),
...
VECTOR_DB_OPERATIONS = {
    ...
    "delete": {"ids": ["vec_001", "vec_002"], "namespace": "test"},
}
