...
class TestHealthChecks:
    ...
    @patch.dict(
        "os.environ",
        {"SLACK_API_TOKEN": "xoxb-test-token", "SLACK_SIGNING_SECRET": "test-secret"},
    )
...
class TestMiddlewareMonitoring:
    ...
    def test_prometheus_middleware_request_tracking(self, client):
        ...
        test_cases = [
            ...
            ),  # This might return 422 due to missing data
        ]
    ...
    def test_concurrent_request_handling(self, client):
        ...
        def make_request():
            ...
            return (
                ...
                response.elapsed if hasattr(response, "elapsed") else None,
            )
